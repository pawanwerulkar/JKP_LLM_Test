...
def send_email_with_report():
    ...
    report_path = os.getenv("REPORT_PATH", r"C:\Users\test_complete\PycharmProjects\KN_LLM\report\test_report.html")
    sender_email = os.getenv("SENDER_EMAIL", "pawanwerulkar1995@gmail.com")
    receiver_email = os.getenv("RECEIVER_EMAILS", "udgam.goyal10@gmail.com,naveen@jkp.org.in,pawanwerulkar1995@gmail.com,sachin.singh@subtlelabs.com,deepak.jain@subtlelabs.com,shravanmurali@gmail.com").split(',')
    ...
    #
    #     # Attach the HTML content to email_body
...
#attach excel
    ...
    try:
        with open(report_path, "rb") as attachment:
            part = MIMEApplication(attachment.read(), Name="final_report.xlsx")
            part['Content-Disposition'] = f'attachment; filename="final_report.xlsx"'
            msg.attach(part)
        logger.debug("Report file attached successfully.")
    except FileNotFoundError as e:
        logger.error(f"Report file not found: {report_path}")
    ...
    # Send the email
    try:
        with smtplib.SMTP("smtp.gmail.com", 587) as server:  # For Gmail SMTP port 587
